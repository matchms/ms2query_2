...
def make_test_fingerprints(nr_of_inchikeys=5):
    ...
    fingerprints = Fingerprints.compute_fingerprints_from_inchi(inchi_per_inchikey, fingerprint_type="daylight", nbits=2048)
    return fingerprints
...
def test_compute_fingerprints_from_inchi():
    ...
    for inchikey in fingerprints.inchikeys:
        fingerprint = _derive_fingerprint_from_inchi(inchi_per_inchikey[str(inchikey)], fingerprint_type="daylight", nbits=2048)
...
def test_subsetting_fingerprint():
    ...
    fingerprints = Fingerprints.compute_fingerprints_from_inchi(inchi_per_inchikey, fingerprint_type="daylight",
                                                                nbits=2048)
    ...
    assert subsetted_fingerprints == Fingerprints.compute_fingerprints_from_inchi(inchi_per_inchikey_subset, fingerprint_type="daylight", nbits=2048)
...
def test_combine_fingerprint(dummy_fingerprints):
    ...
    last_two_fingerprints = Fingerprints.compute_fingerprints_from_inchi(inchi_per_inchikey, nbits=2048, fingerprint_type="daylight")
...
def test_combine_fingerprints_with_replacing():
    inchikey_inchi_pairs_1 = {"RYYVLZVUVIJVGH": "InChI=1S/C8H10N4O2/c1-10-4-9-6-5(10)7(13)12(3)8(14)11(6)2/h4H,1-3H3",
    ...
    inchikey_inchi_pairs_2 = {"RZVAJINKPMORJF": "InChI=1S/C8H10N4O2/c1-10-4-9-6-5(10)7(13)12(3)8(14)11(6)2/h4H,1-3H3",
                            "ZPUCINDJVBIVPJ": "InChI=1S/C8H9NO2/c1-6(10)9-7-2-4-8(11)5-3-7/h2-5,11H,1H3,(H,9,10)"}
    combined = {"RYYVLZVUVIJVGH": "InChI=1S/C8H10N4O2/c1-10-4-9-6-5(10)7(13)12(3)8(14)11(6)2/h4H,1-3H3",
                "ZPUCINDJVBIVPJ": "InChI=1S/C8H9NO2/c1-6(10)9-7-2-4-8(11)5-3-7/h2-5,11H,1H3,(H,9,10)",
